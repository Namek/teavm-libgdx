...
@Replace(Matrix4.class)
public class Matrix4Emulator implements Serializable {
    ...
    /** Do not use this member, instead use a temporary Matrix4 instance, or create a temporary float array. */
    @Deprecated
    public static final float tmp[] = new float[16]; // FIXME Change to private access
    public final float val[] = new float[16];

    /** Constructs an identity matrix */
    public Matrix4Emulator() {
        val[M00] = 1f;
        val[M11] = 1f;
        val[M22] = 1f;
        val[M33] = 1f;
    ...
    public Matrix4Emulator(Matrix4Emulator matrix) {
        this.set(matrix);
    }
    ...
    public Matrix4Emulator(float[] values) {
        this.set(values);
    }
    ...
    public Matrix4Emulator(Quaternion quaternion) {
        this.set(quaternion);
    }
    ...
    public Matrix4Emulator(Vector3 position, Quaternion rotation, Vector3 scale) {
    ...
    public Matrix4Emulator set (Matrix4Emulator matrix) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator set (float[] values) {
        val[M00] = values[M00];
        val[M10] = values[M10];
        val[M20] = values[M20];
        val[M30] = values[M30];
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator set (Quaternion quaternion) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator set (float quaternionX, float quaternionY, float quaternionZ, float quaternionW) {
    ...
    public Matrix4Emulator set (Vector3 position, Quaternion orientation) {
     ...
     * @param quaternionW The W component of the quaternion that is to be used to set this matrix.
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator set (float translationX, float translationY, float translationZ, float quaternionX, float quaternionY,
     ...
     * @param scale The scale
     * @return This matrix for chaining */
    public Matrix4Emulator set (Vector3 position, Quaternion orientation, Vector3 scale) {
    ...
    public Matrix4Emulator set (Vector3 xAxis, Vector3 yAxis, Vector3 zAxis, Vector3 pos) {
        val[M00] = xAxis.x;
        val[M01] = xAxis.y;
        val[M02] = xAxis.z;
        val[M10] = yAxis.x;
    ...
    public Matrix4Emulator cpy () {
        return new Matrix4Emulator(this);
    }
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator trn (Vector3 vector) {
        val[M03] += vector.x;
        val[M13] += vector.y;
        val[M23] += vector.z;
        return this;
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator trn (float x, float y, float z) {
        val[M03] += x;
        val[M13] += y;
        val[M23] += z;
        return this;
    ...
    public Matrix4Emulator mul (Matrix4Emulator matrix) {
     ...
     * @param matrix The other matrix to multiply by.
     * @return This matrix for the purpose of chaining operations together. */
    public Matrix4Emulator mulLeft (Matrix4Emulator matrix) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator setToProjection (float near, float far, float fovy, float aspectRatio) {
        idt();
     ...
     * @param far The far plane
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator setToProjection (float left, float right, float bottom, float top, float near, float far) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator setToOrtho2D (float x, float y, float width, float height) {
     ...
     * @param far The far plane
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator setToOrtho2D (float x, float y, float width, float height, float near, float far) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator setToOrtho (float left, float right, float bottom, float top, float near, float far) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator setTranslation (Vector3 vector) {
        val[M03] = vector.x;
        val[M13] = vector.y;
        val[M23] = vector.z;
        return this;
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator setTranslation (float x, float y, float z) {
        val[M03] = x;
        val[M13] = y;
        val[M23] = z;
        return this;
     ...
     * @param vector The translation vector
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator setToTranslation (Vector3 vector) {
        idt();
        val[M03] = vector.x;
        val[M13] = vector.y;
        val[M23] = vector.z;
     ...
     * @param z The z-component of the translation vector.
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator setToTranslation (float x, float y, float z) {
        idt();
        val[M03] = x;
        val[M13] = y;
        val[M23] = z;
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator setToTranslationAndScaling (Vector3 translation, Vector3 scaling) {
        idt();
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator setToTranslationAndScaling (float translationX, float translationY, float translationZ, float scalingX,
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator setToRotation (Vector3 axis, float degrees) {
        if (degrees == 0) {
            idt();
            return this;
        }
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator setToRotationRad (Vector3 axis, float radians) {
        if (radians == 0) {
            idt();
            return this;
        }
     ...
     * @param degrees The angle in degrees
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator setToRotation (float axisX, float axisY, float axisZ, float degrees) {
        if (degrees == 0) {
            idt();
            return this;
        }
     ...
     * @param radians The angle in radians
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator setToRotationRad (float axisX, float axisY, float axisZ, float radians) {
        if (radians == 0) {
            idt();
            return this;
        }
     ...
     * @return This matrix for the purpose of chaining methods together */
    public Matrix4Emulator setToRotation (final Vector3 v1, final Vector3 v2) {
     ...
     * @return This matrix for the purpose of chaining methods together */
    public Matrix4Emulator setToRotation (final float x1, final float y1, final float z1, final float x2, final float y2, final float z2) {
     ...
     * @return This matrix */
    public Matrix4Emulator setFromEulerAngles (float yaw, float pitch, float roll) {
     ...
     * @return This matrix */
    public Matrix4Emulator setFromEulerAnglesRad (float yaw, float pitch, float roll) {
     ...
     * @return This matrix for chaining. */
    public Matrix4Emulator setToScaling (Vector3 vector) {
        idt();
        val[M00] = vector.x;
        val[M11] = vector.y;
        val[M22] = vector.z;
     ...
     * @return This matrix for chaining. */
    public Matrix4Emulator setToScaling (float x, float y, float z) {
        idt();
        val[M00] = x;
        val[M11] = y;
        val[M22] = z;
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator setToLookAt (Vector3 direction, Vector3 up) {
     ...
     * @param up the up vector
     * @return This matrix */
    public Matrix4Emulator setToLookAt (Vector3 position, Vector3 target, Vector3 up) {
    ...
    public Matrix4Emulator setToWorld (Vector3 position, Vector3 forward, Vector3 up) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator lerp (Matrix4Emulator matrix, float alpha) {
        for (int i = 0; i < 16; i++)
     ...
     * @return This matrix for chaining */
    public Matrix4Emulator avg (Matrix4Emulator other, float w) {
        getScale(tmpVec);
     ...
     * @return This matrix for chaining */
    public Matrix4Emulator avg (Matrix4Emulator[] t) {
     ...
     * @return This matrix for chaining */
    public Matrix4Emulator avg (Matrix4Emulator[] t, float[] w) {
    ...
    public Matrix4Emulator set (Matrix3 mat) {
        val[0] = mat.val[0];
        val[1] = mat.val[1];
        val[2] = mat.val[2];
        val[3] = 0;
     ...
     * @return This matrix for chaining */
    public Matrix4Emulator set (Affine2 affine) {
        val[M00] = affine.m00;
        val[M10] = affine.m10;
        val[M20] = 0;
        val[M30] = 0;
     ...
     * @return This matrix for chaining */
    public Matrix4Emulator setAsAffine (Affine2 affine) {
        val[M00] = affine.m00;
        val[M10] = affine.m10;
        val[M01] = affine.m01;
        val[M11] = affine.m11;
     ...
     * @return This matrix for chaining */
    public Matrix4Emulator setAsAffine (Matrix4Emulator mat) {
        val[M00] = mat.val[M00];
        val[M10] = mat.val[M10];
        val[M01] = mat.val[M01];
        val[M11] = mat.val[M11];
    ...
    public Matrix4Emulator scl (Vector3 scale) {
        val[M00] *= scale.x;
        val[M11] *= scale.y;
        val[M22] *= scale.z;
        return this;
    ...
    public Matrix4Emulator scl (float x, float y, float z) {
        val[M00] *= x;
        val[M11] *= y;
        val[M22] *= z;
        return this;
    ...
    public Matrix4Emulator scl (float scale) {
        val[M00] *= scale;
        val[M11] *= scale;
        val[M22] *= scale;
        return this;
    ...
    public float getScaleXSquared () {
        return val[Matrix4Emulator.M00] * val[Matrix4Emulator.M00] + val[Matrix4Emulator.M01] * val[Matrix4Emulator.M01] + val[Matrix4Emulator.M02] * val[Matrix4Emulator.M02];
    }

    /** @return the squared scale factor on the Y axis */
    public float getScaleYSquared () {
        return val[Matrix4Emulator.M10] * val[Matrix4Emulator.M10] + val[Matrix4Emulator.M11] * val[Matrix4Emulator.M11] + val[Matrix4Emulator.M12] * val[Matrix4Emulator.M12];
    }

    /** @return the squared scale factor on the Z axis */
    public float getScaleZSquared () {
        return val[Matrix4Emulator.M20] * val[Matrix4Emulator.M20] + val[Matrix4Emulator.M21] * val[Matrix4Emulator.M21] + val[Matrix4Emulator.M22] * val[Matrix4Emulator.M22];
    }

    /** @return the scale factor on the X axis (non-negative) */
    public float getScaleX () {
        return (MathUtils.isZero(val[Matrix4Emulator.M01]) && MathUtils.isZero(val[Matrix4Emulator.M02])) ? Math.abs(val[Matrix4Emulator.M00])
        : (float)Math.sqrt(getScaleXSquared());
    }

    /** @return the scale factor on the Y axis (non-negative) */
    public float getScaleY () {
        return (MathUtils.isZero(val[Matrix4Emulator.M10]) && MathUtils.isZero(val[Matrix4Emulator.M12])) ? Math.abs(val[Matrix4Emulator.M11])
        : (float)Math.sqrt(getScaleYSquared());
    }

    /** @return the scale factor on the X axis (non-negative) */
    public float getScaleZ () {
        return (MathUtils.isZero(val[Matrix4Emulator.M20]) && MathUtils.isZero(val[Matrix4Emulator.M21])) ? Math.abs(val[Matrix4Emulator.M22])
    ...
    public Matrix4Emulator toNormalMatrix () {
        val[M03] = 0;
        val[M13] = 0;
        val[M23] = 0;
        return inv().tra();
     ...
     * matrices as you can get from {@link Matrix4Emulator#val}. This is the same as {@link Matrix4Emulator#mul(Matrix4Emulator)}.
     *
     ...
     * from {@link Matrix4Emulator#val}. The vector array is assumed to hold a 3-component vector, with x being the first element, y being
     ...
     * from {@link Matrix4Emulator#val}. The vectors array is assumed to hold 3-component vectors. Offset specifies the offset into the
     ...
     * major matrix as you can get from {@link Matrix4Emulator#val}. The vector array is assumed to hold a 3-component vector, with x being
     ...
     * major matrix as you can get from {@link Matrix4Emulator#val}. The vectors array is assumed to hold 3-component vectors. Offset
     ...
     * column major matrix as you can get from {@link Matrix4Emulator#val}. The vectors array is assumed to hold 3-component vectors.
     ...
     * @param translation
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator translate (Vector3 translation) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator translate (float x, float y, float z) {
        tmp[M00] = 1;
        tmp[M01] = 0;
        tmp[M02] = 0;
        tmp[M03] = x;
     ...
     * @param degrees The angle in degrees.
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator rotate (Vector3 axis, float degrees) {
     ...
     * @param radians The angle in radians.
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator rotateRad (Vector3 axis, float radians) {
     ...
     * @param degrees The angle in degrees
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator rotate (float axisX, float axisY, float axisZ, float degrees) {
        if (degrees == 0) return this;
     ...
     * @param radians The angle in radians
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator rotateRad (float axisX, float axisY, float axisZ, float radians) {
        if (radians == 0) return this;
     ...
     * @param rotation
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator rotate (Quaternion rotation) {
     ...
     * @param v2 The target vector
     * @return This matrix for the purpose of chaining methods together */
    public Matrix4Emulator rotate (final Vector3 v1, final Vector3 v2) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Matrix4Emulator scale (float scaleX, float scaleY, float scaleZ) {
        tmp[M00] = scaleX;
        tmp[M01] = 0;
        tmp[M02] = 0;
        tmp[M03] = 0;
