        ...
        if (pool == null) {
            pool = new Pool(4, max){
                ...
                protected Object newObject(){
                    ...
                    }else if(type == GlyphLayout.class){
                        return new GlyphLayout();
                    }else if(type == Color.class){
                        return new Color();
                    }else if(type == GlyphRun.class){
                        return new GlyphRun();
                    }
                    throw new RuntimeException("invalid pool type");
                }
            };
